...
CREATE TABLE `attendance` (
  ...
  CONSTRAINT `att_e_id` FOREIGN KEY (`employeeId`) REFERENCES `employee` (`id`)
...
INSERT INTO `role` VALUES (1,'Administrator'),(2,'Executive'),(3,'Manager'),(4,'Supervisor'),(5,'Accounting'),(6,'Human Resources'),(7,'Operations'),(8,'Sales'),(9,'IT');
...
CREATE TABLE `transaction_logs` (
  ...
  CONSTRAINT `eployeeId_transaction` FOREIGN KEY (`employeeId`) REFERENCES `employee` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `user_ibfk_1` FOREIGN KEY (`username`, `id`) REFERENCES `employee` (`email`, `id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
